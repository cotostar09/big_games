...
<!--//게임 설정 마무리 -->
    			...
    			<div class="col-md-4 span_8">
    				<div class="activity_box activity_box2">
    					...
    					<form action="#" method="post" onsubmit="return false;">
    						<input type="text" value="게임 명칭 입력" id="gameCodeEdit" onfocus="if (this.value == '게임 명칭 입력') {this.value = '';}" onblur="if (this.value == '') {this.value = '게임 명칭 입력';}" required="">
    						<input type="submit" value="START" onclick="gameStart.startGame();">		
    					</form>
    				</div>
    				<div class="clearfix"> </div>
    			</div>
        	...
        	<div class="modal fade" id="viewPlayerModal" tabindex="-1" role="dialog" aria-labelledby="#viewPlayerModalLabel">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body" id="viewPlayerLists">
									<?=$gameData->viewPlayerList()?>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-default" data-dismiss="modal">닫기</button>
									</div>
